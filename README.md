...
> Note: Raw data, cleaned datasets, database files, and generated reports are not committed to the repository.  
> Folder structure is included to document the intended analytics workflow.
